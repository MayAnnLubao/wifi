...
!!!DAPAT 7 UNDER41SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
!
telephony-service
 moh "flash:/en41bacd41music41on41hold.au"
!
application
 service rivanaa flash:app-b-acd-aa-3.0.0.2.tcl
  ...
  param welcome-prompt flash:en41bacd41welcome.au
...
http://docwiki.cisco.com/wiki/Cisco41IOS41Voice41Troubleshooting41and41Monitoring41--41Tcl41IVR41Troubleshooting
...
!
 voice register global
  mode cme
  source-address 10.41.100.8 port 5060
  max-dn 12
  max-pool 12
...
!
  voice register pool 1
    id mac f06c.5d7d.6e5f
    number 1 dn 1
    dtmf-relay sip-notify
    username 4175 password 4175
    codec g711ulaw
!
  voice register pool 2
    id mac 8E6A.2AEC.3606
    number 1 dn 2
    dtmf-relay sip-notify
    username 4216 password 4216
    codec g711ulaw
!
